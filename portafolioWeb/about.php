                ...
                <div class="carousel-inner team-wrapper">
                    <div class="item active">
                        ...
                        <div class="col-xs-12 col-sm-8 col-md-8 team-member-bio">
                            ...
                            <p class="team-text-short">Poseo más de cuatro años de experiencia en el desarrollo de sitios web y aplicaciones móviles, desde plataformas para marcas personales hasta soluciones de comercio electrónico. Mi formación en el Instituto IACC, junto con capacitaciones en desarrollo web frontend y backend, me ha permitido especializarme en tecnologías como Node.js, Ruby y NetBeans, además de bases de datos relacionales con PostgreSQL y herramientas como DBeaver para la gestión y optimización de consultas.

Durante mi práctica profesional en Emasa en 2023 como analista programador, desarrollé un sistema web interno con autenticación, gestión de roles y acceso dinámico a bases de datos. Además, he trabajado en múltiples proyectos personales, aplicando soluciones integrales en desarrollo web y optimizando rendimiento, seguridad y escalabilidad mediante arquitecturas modernas y mejores prácticas de desarrollo. </p>
                            <ul class="list-inline social-buttons">
                                ...
                                <li><a href="https://github.com/AMarceloRamos" target="t_bank"><i class="fab fa-github"></i></a></li>
                                 <li><a href="https://wa.me/987829030" target="t_bank"><i class="fab fa-whatsapp"></i></a></li>
